...
##' @author
##' @import markdown
ui = function() fluidPage(navbarPage(selected = 'simulation2',
...
'))),
         mainPanel(width = 12,column(8,
                  ...
                  ,
                   column(6,
                          column(12,HTML(markdownToHTML(text ='__Subset target mixture distribution__'))),
